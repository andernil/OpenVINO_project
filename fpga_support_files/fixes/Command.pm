...
sub version {
   my ($self,@args) = @_;
   if ( $#args < 0 ) {
      my $banner = acl::Env::is_sdk() ? 'Intel(R) FPGA SDK for OpenCL(TM), Version 17.1.0 Build 240, Copyright (C) 2017 Intel Corporation' : 'Intel(R) FPGA Runtime Environment for OpenCL(TM), Version 17.1.0 Build 240, Copyright (C) 2017 Intel Corporation';
      print $self->prog." 17.1.0.240 ($banner)\n";
   } else {
