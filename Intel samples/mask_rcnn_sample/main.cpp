...
#include "mask_rcnn_sample.h"
#include <opencv2/opencv.hpp>

using namespace InferenceEngine;

/**
 * @brief The entry point for inference engine Mask RCNN sample application
 * @file mask_rcnn_sample/main.cpp
 * @example mask_rcnn_sample/main.cpp
 */
